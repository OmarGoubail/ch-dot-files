-- Floating terminal window for tuxedo
-- Tuxedo's file is controlled by $TODO_DIR / $TODO_FILE (set in fish config),
-- so this module just launches `tuxedo` and does not create project-local todo.txt.
local M = {}
...
local config_defaults = {
	-- Disabled by default: tuxedo reads $TODO_DIR, so creating a file here
	-- would not affect which file tuxedo opens.
