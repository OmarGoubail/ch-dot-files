-- Herdr + Neovim seamless <C-h/j/k/l> navigation
-- Replaces smart-splits for herdr + Ghostty.
-- The herdr side is a minimal plugin at ~/.config/herdr/plugins/vim-herdr-navigation.
...
local function nav(wincmd, dir)
	...
	-- At a split edge: hand off to herdr (or tmux as a fallback).
